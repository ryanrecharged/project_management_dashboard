...
def login():
    ...
    e.markdown('This is a SUPER app that will organize the way you live, work, and create. <a href="https://field-to-office-gantt.streamlit.app">Learn more</a>.', unsafe_allow_html=True)
