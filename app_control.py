...
def apply_custom_css():
    default = """
        ...
        button.st-emotion-cache-7ym5gk:active {background-color: #593773}
        button.st-emotion-cache-7ym5gk:hover {background-color: #593773cc; color: #ffffff}
...
def apply_custom_floating_container():
    html_style = '''
        ...
        div:has( >.element-container #floating) {
            display: flex;
